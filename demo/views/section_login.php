            ...
            <div class="auth-columns">
                ...
                <div class="auth-form">
                    <div class="control has-text-left">
                        ...
                        <p class="auth-sub" style="color:crimson;">This portal is under construction.
                    </div>
                    <form action="config/action_handler.php" method="post">
                        ...
                        <div class="field">
                            ...
                            <div class="control has-icons-left">
                                <input id="email" name="email" type="email" class="input" autocomplete="username" disabled>
                        ...
                        <div class="field">
                            ...
                            <div class="control has-icons-left">
                                <input id="password" name="pwd" type="password" class="input" autocomplete="current-password" disabled>
                        ...
                        <div class="meta-row">
                            <a class="pw-link" href="#forgot" disabled>Forgot password?</a>
                        </div>

                        <div class="field mt-4">
                            <button type="submit" name="action" value="login" class="button is-medium btn-primary is-fullwidth" disabled>Login</button>
                        </div>
                        <div class="divider mt-3 mb-2">or</div>
                        <div class="buttons">
                            <button type="button" class="button is-light is-fullwidth" disabled>
