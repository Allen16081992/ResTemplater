<section id="home" class="<?= ViewBook::setVisibility('home'); ?>">
  <div class="pw-baseline" id="pwBaseline">
    ...
    <div id="pwStage" class="pw-stage">
      ...
      <!-- STEP: Basics -->
      <form action="./config/pdf_templates/default.src.php" method="post">
        <article class="pw-card" data-step="basics">
          ...
          <div class="pw-form">
            <div>
              <label for="fullName" class="pw-label">Full name *</label>
              <input type="text" id="fullName" name="fullName" class="pw-input" placeholder="e.g. Allen Pieter" autocomplete="name">
            </div>
        ...
        <article class="pw-card" data-step="contact">
          ...
          <div class="pw-form">
            <div>
              ...
              <input type="email" id="email" name="contact[email]" class="pw-input" placeholder="you@example.com" autocomplete="email">
            </div>

            <div class="pw-row">
              <div>
                <label class="pw-label" for="city">City</label>
                <input type="text" id="city" name="contact[city]" class="pw-input" placeholder="e.g. Feyenoord" autocomplete="address-level2">
              </div>
              <div>
                <label class="pw-label" for="country">Country</label>
                <input type="text" id="country" name="contact[country]" class="pw-input" placeholder="e.g. Netherlands" autocomplete="country-name">
              </div>
            </div>
            ...
            <div class="pw-row">
              <div>
                ...
                <input type="url" id="website" name="contact[website]" class="pw-input" placeholder="https://example.com">
              </div>
              <div>
                <label class="pw-label" for="phone">Phone</label>
                <input type="tel" id="phone" name="contact[phone]" class="pw-input" placeholder="+31…" autocomplete="tel">
              </div>
            </div>
          </div>
        </article>
        ...
        <article class="pw-card" data-step="download">
          <div class="pw-final-only">
            <button type="submit" name="resume" class="pw-btn pw-btn-primary">Let’s download</button>
          </div>
        </article>
      </form>
