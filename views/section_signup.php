            ...
            <div class="auth-columns">
                ...
                <div class="auth-form">
                    <div class="control has-text-left">
                        ...
                        <p class="auth-sub">Start your journey to a resume without bullshit.</p>
                    </div>

                    <form id="signup_form" action="engine/action_handler.php" method="post">
                        ...
                        <div class="field">
                            ...
                            <div class="control has-icons-left">
                                <input id="email" name="email" type="email" class="input" value="hallohallo@gmail.com<?= ViewBook::setOldForm('email'); ?>" placeholder="you@domain.com" autocomplete="email" required>
                        ...
                        <div class="field toggle-eye">
                            ...
                            <div class="control has-icons-left">            
                                <input id="pwdField" type="password" name="pwd" class="input" placeholder="••••••••" value="Hallohallo33" required>
                                <span class="icon is-small is-left">
                        ...
                        <div class="field m-3">
                            ...
                            I agree to the <a data-section="policy">terms</a> and <a data-section="policy">conditions</a>.
                            </label>
                        </div>
